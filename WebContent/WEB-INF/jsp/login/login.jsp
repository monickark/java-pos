        ...
        <form:form class="login-form" method="POST"
          ...
          <div class="row margin">
            <div class="input-field col s12">
              ...
              <form:input type="text" placeholder="Username" path="userId" id="username" required="true" />
          ...
          <div class="row margin">
            <div class="input-field col s12">
              ...
              <form:input class="m-wrap"  placeholder="Password" type="password" path="password"
