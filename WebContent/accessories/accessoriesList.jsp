				...
				<div id="profile-page-sidebar" class="col s12 m12">
					...
					<div class="col s12  grey lighten-4 acces-add-tab">
						<div class="row">
							...
							<div class="input-field col s6">
								<form:input type="text" name="name" class="input-field" path="name" /> <label
									class="">Name <span>*</span></label>
							</div>

							 <div class="input-field col s6">
								<form:input type="text" name="qty" class="input-field" path="quantity" /> <label
									class="">Quantity </label>
							</div>

							<div class="input-field col s6">
								<form:input type="text" name="cost-price" class="input-field" path="costPrice"/> <label
									class="">Cost Price </label>
							</div>
							<div class="input-field col s6">
								<form:input type="text" name="selling-price" class="input-field" path="sellingPrice"/> <label
