...
import com.pos.admin.service.IDataLogService;
...
public class DataLogController {
	...
	public ModelAndView getDataLogPage(
		...
		modelAndView = new ModelAndView(".pos.dataLog");
	...
	public ModelAndView getDataLogPage(
		...
		if ((request.getParameter("action") != null)
			...
			modelAndView = new ModelAndView(".pos.dataLogDetails");
		}
	...
	public ModelAndView handleException(Exception ex, HttpSession session,
		...
		if (dataLogSearchVO != null) {
			mav = new ModelAndView(".pos.dataLog", "dataLog", dataLogSearchVO);
		}
