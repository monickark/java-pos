...
import com.pos.batch.service.IDownloadFileService;
...
public class DownLoadFileController {
	...
	public ModelAndView renderDownloadFilePage(
		...
		ModelAndView model = new ModelAndView(".pos.exportFiles");
	...
	public ModelAndView handleException(Exception ex, HttpSession session,
		...
		ModelAndView mav = new ModelAndView(".pos.exportFiles", "fileDownLoad",
				fileDownLoadVO);
