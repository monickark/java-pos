...
public class ProductInventory implements Serializable{
	...
	Logger logger=Logger.getLogger(ProductInventory.class);
	...
	public String toString() {
		return "ProductInventory [logger=" + logger + ", productId=" + productId + ", productName=" + productName
				+ ", category=" + category + ", brand=" + brand + ", colour=" + colour + ", model=" + model
				+ ", inventoryId=" + inventoryId + ", inventoryDate=" + inventoryDate + ", imei=" + imei + ", costPrice="
				+ costPrice + ", sellPrice=" + sellPrice + "]";
	}
